...
import co.gov.umv.sigma.backend.intervencion.dao.impl.AreaIntervencionDAO;
...
public class AreaIntervencionDTO implements ICrudDTO {

	ICrudDAO modelo = new AreaIntervencionDAO();
