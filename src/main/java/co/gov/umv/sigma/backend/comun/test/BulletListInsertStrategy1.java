...
public class BulletListInsertStrategy1 implements InsertStrategy {

    private InsertStrategyChooser1 insertStrategyChooser;
    private ParagraphCleaner paragraphCleaner;

    public BulletListInsertStrategy1(InsertStrategyChooser1 insertStrategyChooser, ParagraphCleaner paragraphCleaner) {
