 ...
 */
public class Docx1 implements Serializable {
     ...
     */
    private DocumentCleaner1 documentCleaner;

    public Docx1(String docxPath) {
        this.docxPath = docxPath;
        open();
        this.documentCleaner = new DocumentCleaner1();
    }
    ...
    public void fillTemplate(Variables variables) {
        ...
        DocumentExecutor1 documentExecutor = new DocumentExecutor1(variables);
