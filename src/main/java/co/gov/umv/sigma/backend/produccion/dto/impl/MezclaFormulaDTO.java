...
import co.gov.umv.sigma.backend.produccion.dao.impl.MezclaDetalleDAO;

public class MezclaFormulaDTO implements ICrudDTO
{

	MezclaDetalleDAO modelo = new MezclaDetalleDAO();
