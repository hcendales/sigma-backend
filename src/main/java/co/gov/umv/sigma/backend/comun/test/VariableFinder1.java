...
public class VariableFinder1 {
    ...
    public VariableFinder1(Variables variables) {
        this.tableRowCleaner = new TableRowCleaner();
        this.paragraphCleaner = new ParagraphCleaner();
        this.keyExtractor = new KeyExtractor();
        this.insertStrategyChooser = new InsertStrategyChooser1(variables, tableRowCleaner, paragraphCleaner);
    }
