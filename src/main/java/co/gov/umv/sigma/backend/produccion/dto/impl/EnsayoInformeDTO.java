...
import co.gov.umv.sigma.backend.produccion.dao.impl.EnsayoInformeDAO;

public class EnsayoInformeDTO implements ICrudDTO
{

	EnsayoInformeDAO modelo = new EnsayoInformeDAO();
