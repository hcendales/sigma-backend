...
import co.gov.umv.sigma.backend.intervencion.dao.impl.InfDiaCuadrillaObservacionDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class InfDiaCuadrillaObservacionDTO implements ICrudDTO {
	ICrudDAO modelo = new InfDiaCuadrillaObservacionDAO();
	@Override
