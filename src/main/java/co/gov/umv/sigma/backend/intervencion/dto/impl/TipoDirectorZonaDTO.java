...
import co.gov.umv.sigma.backend.intervencion.dao.impl.TipoDirectorZonaDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class TipoDirectorZonaDTO implements ICrudDTO {

	ICrudDAO modelo = new TipoDirectorZonaDAO();
