...
import co.gov.umv.sigma.backend.intervencion.dao.impl.InfDiaCuadrillaMaquinariaDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class InfDiaCuadrillaMaquinariaDTO implements ICrudDTO {
	ICrudDAO modelo = new InfDiaCuadrillaMaquinariaDAO();
	@Override
