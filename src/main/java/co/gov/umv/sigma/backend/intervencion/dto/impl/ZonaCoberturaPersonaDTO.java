...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ZonaCoberturaPersonaDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ZonaCoberturaPersonaDTO implements ICrudDTO
{
	ICrudDAO modelo = new ZonaCoberturaPersonaDAO();
