...
import co.gov.umv.sigma.backend.mejoramiento.dao.impl.EquipoPersonaDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class EquipoPersonaDTO implements ICrudDTO
{

	ICrudDAO modelo = new EquipoPersonaDAO();
