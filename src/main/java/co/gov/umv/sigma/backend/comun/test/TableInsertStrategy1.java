...
public class TableInsertStrategy1 implements InsertStrategy {

    private Variables variables;
    private InsertStrategyChooser1 insertStrategyChooser;
    private TableRowCleaner tableRowCleaner;

    public TableInsertStrategy1(Variables variables, InsertStrategyChooser1 insertStrategyChooser,
