...
import co.gov.umv.sigma.backend.intervencion.dao.impl.TipoDirectorApoyoDAO;

public class TipoDirectorApoyoDTO implements ICrudDTO {

	ICrudDAO modelo = new TipoDirectorApoyoDAO();
