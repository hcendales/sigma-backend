...
import co.gov.umv.sigma.backend.intervencion.dao.impl.InfDiaCuadrillaSalMaterialDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class InfDiaCuadrillaSalMaterialDTO implements ICrudDTO {

	ICrudDAO modelo = new InfDiaCuadrillaSalMaterialDAO();
	@Override
