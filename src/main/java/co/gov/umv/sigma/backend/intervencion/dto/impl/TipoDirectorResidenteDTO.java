...
import co.gov.umv.sigma.backend.intervencion.dao.impl.TipoDirectorResidenteDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class TipoDirectorResidenteDTO implements ICrudDTO {

	ICrudDAO modelo = new TipoDirectorResidenteDAO();
