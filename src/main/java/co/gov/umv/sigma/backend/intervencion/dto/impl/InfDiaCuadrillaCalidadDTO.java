...
import co.gov.umv.sigma.backend.intervencion.dao.impl.InfDiaCuadrillaCalidadDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class InfDiaCuadrillaCalidadDTO implements ICrudDTO {
	ICrudDAO modelo = new InfDiaCuadrillaCalidadDAO();
	@Override
