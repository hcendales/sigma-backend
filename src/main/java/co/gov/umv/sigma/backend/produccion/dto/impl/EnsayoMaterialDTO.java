...
import co.gov.umv.sigma.backend.produccion.dao.impl.EnsayoMaterialDAO;

public class EnsayoMaterialDTO implements ICrudDTO
{

	EnsayoMaterialDAO modelo = new EnsayoMaterialDAO();
