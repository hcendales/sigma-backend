...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ZonaCoberturaEquipoDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ZonaCoberturaEquipoDTO implements ICrudDTO
{
	ICrudDAO modelo = new ZonaCoberturaEquipoDAO();
