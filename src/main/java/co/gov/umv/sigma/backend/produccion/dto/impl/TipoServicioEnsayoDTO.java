...
import co.gov.umv.sigma.backend.produccion.dao.impl.TipoServicioEnsayoDAO;

public class TipoServicioEnsayoDTO implements ICrudDTO
{

	TipoServicioEnsayoDAO modelo = new TipoServicioEnsayoDAO();
