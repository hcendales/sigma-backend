...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ZonaCoberturaUnidadEDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ZonaCoberturaUnidadEjecDTO  implements ICrudDTO
{
	ICrudDAO modelo = new ZonaCoberturaUnidadEDAO();
