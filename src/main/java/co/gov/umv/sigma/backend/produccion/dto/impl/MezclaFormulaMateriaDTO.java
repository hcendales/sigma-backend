...
import co.gov.umv.sigma.backend.produccion.dao.impl.MezclaDetalleMateriaDAO;

public class MezclaFormulaMateriaDTO implements ICrudDTO
{

	MezclaDetalleMateriaDAO modelo = new MezclaDetalleMateriaDAO();
