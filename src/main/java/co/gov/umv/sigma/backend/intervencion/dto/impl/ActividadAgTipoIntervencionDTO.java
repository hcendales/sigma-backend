...
import co.gov.umv.sigma.backend.intervencion.dao.impl.ActividadAgTipoIntervencionDAO;
import co.gov.umv.sigma.backend.mejoramiento.dao.ICrudDAO;
import co.gov.umv.sigma.backend.mejoramiento.dto.ICrudDTO;

public class ActividadAgTipoIntervencionDTO implements ICrudDTO {

	ICrudDAO modelo = new ActividadAgTipoIntervencionDAO();
